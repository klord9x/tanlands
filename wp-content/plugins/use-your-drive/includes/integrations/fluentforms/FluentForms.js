(function ($) {
    ...
    function openShortcodeBuilder(shortcode) {
        ...
        var $iframe_template = $("<iframe src='" + window.ajaxurl + "?action=useyourdrive-getpopup&type=shortcodebuilder&standalone=1&asuploadbox=1&" + query + "' width='100%' height='600' tabindex='-1' frameborder='0'></iframe>");
