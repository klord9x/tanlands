jQuery(document).ready(function ($) {
    ...
    $.widget("cp.UseyourDriveWC", {
        ...
        _loadDetails: function (item_id, listtoken) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var $upload_list = $('#wpcp-useyourdrive-uploads-' + item_id + ' .wpcp-uploads-list');
                    $upload_list.html('');
        ...
        openUploadBox: function (button) {
            ...
            var modalbody = $('<div class="useyourdrive-modal-body" tabindex="0" style="height: 100%; padding:0;"></div>');
            var modaldialog = $('<div id="useyourdrive-modal-action" class="UseyourDrive useyourdrive-modal ' + this.options.content_skin + '"><div class="modal-dialog" style="max-width: 80vw;"><div class="modal-content" style="max-height: 90%;"></div></div></div>');
            ...
            /* Fill Textarea */
            $('.useyourdrive-modal-body').append(container);
            container.show();

            /* Set the button actions */
            $('#useyourdrive-modal-action .useyourdrive-modal-confirm-btn').on('click', function (e) {
                modal_action.close();
            });
